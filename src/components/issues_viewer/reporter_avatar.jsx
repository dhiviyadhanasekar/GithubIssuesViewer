...
var ReporterAvatar = module.exports = React.createClass({
    ...
    render: function(){
      ...
      var userName = <div className='verysmall row margin_auto_left ' style={{paddingTop: 2}}>
      ...
      return (
        <a className='flex_center column margin_10_left gray pointer no_underline auto_width' href={this.props.user.html_url}>
            <UserAvatar user={this.props.user} klass={'row margin_auto_left margin_20_right'} />
            {userName}
        </a>
      )
    }
