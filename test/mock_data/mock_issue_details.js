// var MockIssueDetails = module.exports = "- [x] `↵↵↵↵<!--`↵↵    Thank you for contributing to npm! Please review this checklist↵    before submitting your issue.↵↵    - Please check if there's a solution in the troubleshooting wiki:↵      https://github.com/npm/npm/wiki/Troubleshooting↵↵    - Also ensure that your new issue conforms to npm's contribution guidelines:↵      https://github.com/npm/npm/wiki/Contributing-Guidelines↵↵    - Participation in this open source project is subject to the npm Code of Conduct:↵      https://www.npmjs.com/policies/conduct↵↵    If you're here to provide a feature request, uncomment the final block below.↵-->↵↵### I'm opening this issue because:↵↵  ↵
// ↵
// ↵- [x] npm is crashing
// ↵ 
// ↵
